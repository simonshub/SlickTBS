...
import static game.data.world.map.WorldGenerator.MOUNTAIN_CHAIN_MIN_LEN;
import static game.data.world.map.WorldGenerator.WASTELAND_RADIAL_MAX_SIZE;
import static game.data.world.map.WorldGenerator.WASTELAND_RADIAL_MIN_SIZE;
import static game.data.world.map.WorldGenerator.generateChain;
